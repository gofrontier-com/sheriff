...
func FilterForGroupEligibilitySchedulesToUpdate(
	...
	linq.From(schedules).WhereT(func(a *core.Schedule) bool {
		idx := linq.From(existingSchedules).IndexOfT(func(s models.PrivilegedAccessGroupEligibilityScheduleable) bool {
